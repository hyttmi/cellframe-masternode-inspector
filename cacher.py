            ...
            while True:
                for network in masternode_helpers._active_networks_config:
                    ...
                    new_data = {
                        ...
                        "validator_average_fee": utils.val_to_coins(masternode_helpers._active_networks_config[network].get('validator_average_fee')),
                        "validator_min_fee": utils.val_to_coins(masternode_helpers._active_networks_config[network].get('validator_min_fee')),
                        "validator_max_fee": utils.val_to_coins(masternode_helpers._active_networks_config[network].get('validator_max_fee')),
                    }
